...
modified | [Date](/rest-api/usage/#date-format) | false | false | "YYYY-MM-DDThh:hh:mm:ss" | Date of the last modification of the event | |
...
start | [Date](/rest-api/usage/#date-format) | true | true |  | Start time of the event | |
end | [Date](/rest-api/usage/#date-format) | true | true |  | End time of the event | |
start_timezone | String | true | true |  | Time zone of the start time of this event | [Timezone](/rest-api/usage/#timezone-format) |
end_timezone | String | true | true |  | Time zone of the end time of this event | [Timezone](/rest-api/usage/#timezone-format) |
